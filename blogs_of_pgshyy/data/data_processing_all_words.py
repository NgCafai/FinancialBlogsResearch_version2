...
def process_original_blogs_all_words(blogger_name):
    ...
    for i in range(0, len(blogs)):
        ...
        if '易经演股法' in headline or '炒股逢仙记' in headline or '告诉大家一套炒股方法' in headline or \
                '如何树立正确的股市操作理念' in headline or '股市江湖' in headline or ('第' in headline and '章' in headline):
            continue
        ...
        content = blogs[i][3]
        # 去掉无用的段落
        if '祝大家好运气！！！' in content:
            content = content[0: content.find('祝大家好运气！！！')]
...
if __name__ == '__main__':
    process_original_blogs_all_words("第六感觉")
