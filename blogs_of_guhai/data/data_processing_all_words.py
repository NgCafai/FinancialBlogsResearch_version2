...
def process_original_blogs_all_words(blogger_name):
    ...
    for i in range(0, len(blogs)):
        ...
        content = blogs[i][3]
        # 去掉无用的段落
        if '个人观点，仅供您参考' in content:
            content = content[0: content.find('个人观点，仅供您参考')]
        if '“股海上的灯塔”永远是股民朋友在波涛惊浪的股海上可以停靠的宁静港湾......' in content:
            content = content.replace('“股海上的灯塔”永远是股民朋友在波涛惊浪的股海上可以停靠的宁静港湾......', '')
...
if __name__ == '__main__':
    process_original_blogs_all_words("股海上的灯塔")
